...
# def generateCode():
#     #Create a QRCode of the size specified by the user
#     qr = qrcode.QRCode(version = size.get(), 
#                        box_size = 10, 
#                        border = 5)
#     qr.add_data(text.get()) #Adding the data to be encoded 
#     qr.make(fit = True)
...
# label1 = Label(Frame1, text="Enter the text/URL: ", bg="SteelBlue3", fg='azure', font=('Times',20,'bold'))
# label1.place(relx=0.05,rely=0.2, relheight=0.08)

# text = Entry(Frame1, font=('Century 12'))
# text.place(relx=0.05, rely=0.2, relheight=0.08)
...
# label2 = Label(Frame2, text="Enter location to save the QR Code: ", bg="SteelBlue3")
...
# label4.place(relx=0.05, rely=0.4, relwidth=0.5, relheight=0.2)
